        ...
        return (
            ...
            <div className="md:grid flex flex-col gap-3 grid-cols-12 lg:min-h-[55vh]">
                <div className="lg:col-span-3 md:col-span-4 col-span-6">
                    <section className=" rounded space-y-2 lg:h-[55vh] md:h-[45vh]  h-[30vh]  flex flex-col items-center justify-center p-3 shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)]">
                        <div className="border border-red-500 rounded-full overflow-hidden flex  ">
                            <img referrerPolicy="no-referrer" className="h-25  w-25  " src={user?.photoURL ? user.photoURL : userAvatar} alt="" />
                        </div>
